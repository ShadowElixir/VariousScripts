...
echo Press 5 to Launch PostInstall (by ShadowElixir)
...
if %homeoption% == 2 powershell "irm cutt.ly/windows-debloat | iex"
if %homeoption% == 3 pwsh -Command "irm cutt.ly/powerprofile | iex"
if %homeoption% == 4 wsreset -i
if %homeoption% == 5 powershell "irm cutt.ly/postinstall-confirmation | iex"
