...
echo Press 4 to Launch ShadowOS (ShadowOS by ShadowElixir, Doesn't work for now)
echo Press 5 to Launch noahOS (noahOS by NoahTheTechGenius, Doesn't work for now)
echo ------------------------------------------------------------------------------
set /p homeoption=
...
if %homeoption% == 5 echo placeholder
